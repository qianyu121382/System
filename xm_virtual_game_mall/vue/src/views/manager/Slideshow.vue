  ...
  <div>
    ...
    <el-dialog title="轮播图信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        <el-form-item prop="virtual_gameId" label="关联宠物">
          <el-select style="width: 100%" v-model="data.form.virtual_gameId">
            <el-option v-for="item in data.virtual_gameList" :key="item.id" :value="item.id" :label="item.name"></el-option>
          </el-select>
        </el-form-item>
...
request.get('/virtual_game/selectAll', {
  ...
  data.virtual_gameList = res.data
})
