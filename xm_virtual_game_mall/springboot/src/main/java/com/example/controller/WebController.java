...
public class WebController {
    ...
    public Result count() {
        ...
        BigDecimal virtual_gameOrders = virtualGameOrdersService.selectAll(null).stream().filter(o -> !"已取消".equals(o.getStatus()))
        ...
        map.put("virtual_gameShop", virtualGameShopList.size());
        map.put("virtual_game", virtualGameList.size());
        map.put("forum", forumList.size());
        map.put("virtual_gameOrders", virtual_gameOrders);
    ...
    public Result bar() {
        List<VirtualGameShop> virtualGameShopList = virtualGameShopService.selectAll(null).stream().filter(ps -> "审核通过".equals(ps.getStatus())).toList();
        List<String> virtual_gameShopNameList = virtualGameShopList.stream().map(VirtualGameShop::getName).toList();
        ...
        HashMap<String, Object> map = new HashMap<>();
        map.put("virtual_gameShopNameList", virtual_gameShopNameList);
        map.put("totalList", totalList);
        return Result.success(map);
    }
}
