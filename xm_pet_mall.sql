/*
 ...
 Source Schema         : xm_virtualGame_mall
...
CREATE TABLE `virtualGame_orders`  (
  ...
  `user_id` int(11) NULL DEFAULT NULL COMMENT '用户id',
  `shop_id` int(11) NULL DEFAULT NULL COMMENT '宠物店id',
  `virtualGame_id` int(11) NULL DEFAULT NULL COMMENT '宠物id',
...
CREATE TABLE `slideshow`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `virtualGame_id` int(11) NULL DEFAULT NULL COMMENT '关联宠物',
