  ...
  routes: [
    { path: '/', redirect: '/manager/home' },
    {
      ...
      children: [
        ...
        { path: 'petType', meta: { name: '宠物类型' }, component: () => import('@/views/manager/PetType.vue'), },
        { path: 'goodsType', meta: { name: '宠物用品类型' }, component: () => import('@/views/manager/GoodsType.vue'), },
        { path: 'petShop', meta: { name: '宠物店主信息' }, component: () => import('@/views/manager/PetShop.vue'), },
        ...
        { path: 'pet', meta: { name: '宠物信息' }, component: () => import('@/views/manager/Pet.vue'), },
        ...
        { path: 'petOrders', meta: { name: '宠物订单信息' }, component: () => import('@/views/manager/PetOrders.vue'), },
