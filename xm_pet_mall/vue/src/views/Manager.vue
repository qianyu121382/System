      ...
      <div class="manager-main-left">
        ...
        >
          ...
          <el-sub-menu index="1" v-if="data.user.role === 'ADMIN' || (data.user.role === 'PETSHOP' && data.user.status === '审核通过')">
            ...
            <el-menu-item index="/manager/petType" v-if="data.user.role === 'ADMIN'">宠物类型</el-menu-item>
            <el-menu-item index="/manager/goodsType" v-if="data.user.role === 'ADMIN'">宠物用品类型</el-menu-item>
            <el-menu-item index="/manager/pet">宠物信息</el-menu-item>
            <el-menu-item index="/manager/goods">宠物用品信息</el-menu-item>
            <el-menu-item index="/manager/petOrders">宠物订单信息</el-menu-item>
          ...
          <el-sub-menu index="2" v-if="data.user.role === 'ADMIN'">
            ...
            <el-menu-item index="/manager/petShop">宠物店主信息</el-menu-item>
