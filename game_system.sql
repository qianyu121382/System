/*
 ...
 Source Schema         : game_system

 Target Server Type    : MySQL
 Target Server Version : 80038 (8.0.38)
 File Encoding         : 65001

 Date: 30/12/2024 10:51:11
*/
...
CREATE TABLE `cart`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '购物车' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `cart` VALUES (10, 4, 16, 1);
...
CREATE TABLE `collect`  (
  ...
  `user_id` int NULL DEFAULT NULL COMMENT '用户id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 114 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '收藏信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `goods`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `shop_id` int NULL DEFAULT NULL COMMENT '店铺',
  ...
  `store` int NULL DEFAULT NULL COMMENT '剩余数量',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `slideshow`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `virtualGame_id` int NULL DEFAULT NULL COMMENT '关联宠物',
...
CREATE TABLE `virtualgame`  (
  ...
  `store` int NULL DEFAULT 0 COMMENT '剩余数量',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for virtualgame_orders
-- ----------------------------
DROP TABLE IF EXISTS `virtualgame_orders`;
CREATE TABLE `virtualgame_orders`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `order_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '订单号',
  `user_id` int NULL DEFAULT NULL COMMENT '用户id',
  `shop_id` int NULL DEFAULT NULL COMMENT '宠物店id',
  `virtualGame_id` int NULL DEFAULT NULL COMMENT '宠物id',
  `virtualGame_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '宠物名称',
  `virtualGame_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '宠物图片',
  `price` decimal(10, 2) NULL DEFAULT NULL COMMENT '宠物价格',
  `pickup_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '收货人名称',
  `pickup_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '收货人地址',
  `pickup_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '收货人电话',
...
-- ----------------------------
-- Records of virtualgame_orders
-- ----------------------------
INSERT INTO `virtualgame_orders` VALUES (15, '2024120412716', 4, 12, 7, '小丑鱼', 'http://localhost:9090/files/download/1733128989756-1732246527963-小丑鱼.png', 100.00, '小青哥哥哥', '合肥市蜀山区科技大道101号', '13899887766', '待发货', '2024-12-04 15:13:32');
INSERT INTO `virtualgame_orders` VALUES (16, '2024120430370', 4, 12, 7, '小丑鱼', 'http://localhost:9090/files/download/1733128989756-1732246527963-小丑鱼.png', 100.00, '小青哥哥哥', '合肥市蜀山区科技大道101号', '13899887766', '已取消', '2024-12-04 15:33:50');
INSERT INTO `virtualgame_orders` VALUES (17, '2024120430361', 4, 12, 7, '小丑鱼', 'http://localhost:9090/files/download/1733128989756-1732246527963-小丑鱼.png', 100.00, '小青哥哥哥', '合肥市蜀山区科技大道101号', '13899887766', '待支付', '2024-12-04 15:53:50');
INSERT INTO `virtualgame_orders` VALUES (18, '2024120468101', 8, 12, 7, '小丑鱼', 'http://localhost:9090/files/download/1733128989756-1732246527963-小丑鱼.png', 100.00, '小妹妹', '北京市丰台区莲花池路1110号', '13988997766', '已完成', '2024-12-04 15:56:08');
INSERT INTO `virtualgame_orders` VALUES (19, '2024121016102', 4, 11, 4, '金毛寻回犬', 'http://localhost:9090/files/download/1733125943746-1731554448814-金毛01.jpg', 100.00, '小青哥哥哥', '合肥市蜀山区科技大道101号', '13899887766', '待发货', '2024-12-10 15:41:56');
INSERT INTO `virtualgame_orders` VALUES (20, '2024121016706', 4, 15, 10, '小柴犬', 'http://localhost:9090/files/download/1733278379510-1731396169854-小型柴犬01.jpg', 1000.00, '小青哥哥', '合肥市政务区阳光大道1100号', '13877886688', '待发货', '2024-12-10 16:00:16');
INSERT INTO `virtualgame_orders` VALUES (21, '2024121031599', 4, 13, 5, '虎皮鹦鹉', 'http://localhost:9090/files/download/1733126623940-1731548086622-虎皮鹦鹉01.png', 100.00, '小青哥哥哥', '合肥市蜀山区科技大道101号', '13899887766', '待发货', '2024-12-10 16:00:31');

-- ----------------------------
-- Table structure for virtualgame_shop
-- ----------------------------
DROP TABLE IF EXISTS `virtualgame_shop`;
CREATE TABLE `virtualgame_shop`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  ...
  `sell_virtualGame` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '销售宠物',
...
-- ----------------------------
-- Records of virtualgame_type
-- ----------------------------
INSERT INTO `virtualgame_type` VALUES (3, '哺乳类');
INSERT INTO `virtualgame_type` VALUES (4, '鸟类');
INSERT INTO `virtualgame_type` VALUES (5, '爬行类');
INSERT INTO `virtualgame_type` VALUES (6, '两栖类');
INSERT INTO `virtualgame_type` VALUES (7, '昆虫类');
INSERT INTO `virtualgame_type` VALUES (8, '鱼类');
