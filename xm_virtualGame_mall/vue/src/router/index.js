  ...
  routes: [
    { path: '/', redirect: '/manager/home' },
    {
      ...
      children: [
        ...
        { path: 'virtualGameType', meta: { name: '游戏周边' }, component: () => import('@/views/manager/VirtualGameType.vue'), },
        { path: 'goodsType', meta: { name: '游戏周边类型' }, component: () => import('@/views/manager/GoodsType.vue'), },
        { path: 'virtualGameShop', meta: { name: '游戏店主信息' }, component: () => import('@/views/manager/VirtualGameShop.vue'), },
        ...
        { path: 'virtualGame', meta: { name: '游戏信息' }, component: () => import('@/views/manager/VirtualGame.vue'), },
        { path: 'slideshow', meta: { name: '轮播图信息' }, component: () => import('@/views/manager/Slideshow.vue'), },
        { path: 'goods', meta: { name: '游戏周边信息' }, component: () => import('@/views/manager/Goods.vue'), },
        { path: 'address', meta: { name: '用户收货地址信息' }, component: () => import('@/views/manager/Address.vue'), },
        { path: 'virtualGameOrders', meta: { name: '游戏订单信息' }, component: () => import('@/views/manager/VirtualGameOrders.vue'), },
        { path: 'goodsOrders', meta: { name: '游戏周边订单信息' }, component: () => import('@/views/manager/GoodsOrders.vue'), },
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'virtualGameDetail', component: () => import('@/views/front/VirtualGameDetail.vue'), },
        { path: 'virtualGameShopDetail', component: () => import('@/views/front/VirtualGameShopDetail.vue'), },
        { path: 'virtualGameShop', component: () => import('@/views/front/VirtualGameShop.vue'), },
        { path: 'virtualGame', component: () => import('@/views/front/VirtualGame.vue'), },
