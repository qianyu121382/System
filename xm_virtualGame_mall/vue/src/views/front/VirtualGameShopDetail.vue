  ...
  <div style="width: 60%; margin: 10px auto">
    ...
    <div class="card" style="padding: 20px; margin-bottom: 20px">
      ...
      <div style="padding-top: 20px" v-if="data.total > 0">
        <el-row :gutter="20">
         <el-col :span="6" v-for="item in data.virtualGameList" :key="item.id">
           <div style="cursor: pointer" @click="router.push('/front/virtualGameDetail?id=' + item.id)">
...
request.get('/virtualGameShop/selectById/' + data.id).then(res => {
  data.shop = res.data
})
...
const loadPetList = () => {
  ...
  request.get('/virtualGame/selectPage', {
    ...
    data.virtualGameList = res.data?.list
