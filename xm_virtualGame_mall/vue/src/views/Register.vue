<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #f3a119">欢 迎 注 册</div>
      <el-form ref="formRef" :model="data.form" :rules="data.rules">
        ...
        <el-form-item prop="role">
          <el-select v-model="data.form.role" style="width: 100%" size="large" placeholder="请选择角色">
            ...
            <el-option label="游戏店主" value="GAMESHOP"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
          <el-button size="large" type="primary" style="width: 100%; background-color: #f3a119; border-color: #f3a119" @click="register">注 册</el-button>
        </el-form-item>
        <div style="text-align: right">
          已有账号？请 <a style="color: #2779ed" href="/login">登录</a>
        </div>
      </el-form>
    </div>
  </div>
